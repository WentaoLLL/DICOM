    ...
    <div>
        ...
        <div class="mian">
            <el-card class="box-card">
                <div class="haeder-search">
                    <el-input placeholder="Bitte Benutzername oder Telefon Nr. eingeben!" v-model="key_word" class="input-with-select">
                ...
                <el-table :data="tableData" style="width: 100%">
                    ...
                    <el-table-column prop="phone" label="Telefon Nr."></el-table-column>
                    <el-table-column prop="emial" label="E-Mail"></el-table-column>
                    <el-table-column label="Role">
                        <template scope="scope">
                            <span>
                                {{
                                scope.row.roles === "doctor" ? "Arzt" : scope.row.roles === "researcher"?"Forscher":"Kranker"
                                }}
                            </span>
                        </template>
                    </el-table-column>
        ...
        >
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="dialogVisible = false">Bestimmt</el-button>
            </span>
        </el-dialog>
        ...
        <el-dialog
            ...
            :before-close="handleClose"
        >
            <el-select v-model="roles" placeholder="Bitte wählen!">
                <el-option label="Arzt" value="doctor"></el-option>
                <el-option label="Kranker" value="patient"></el-option>
                <el-option label="Forscher" value="researcher"></el-option>
            </el-select>
            <span slot="footer" class="dialog-footer">
                <el-button @click="dialogVisibleRole = false">Zurückgehen</el-button>
                <el-button type="primary" @click="handleEditEoles">Bestimmt</el-button>
            </span>
        </el-dialog>
    </div>
</template>
